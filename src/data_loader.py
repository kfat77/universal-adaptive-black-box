...
def load_tabular_data(path: str | Path, target_columns: str | Sequence[str],
                      feature_columns: str | Sequence[str] | None = None,
                      sheet_name: str | int = 0) -> TabularDataset:
    ...
    features = (_column_names(feature_columns, "feature_columns")
